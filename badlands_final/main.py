...
def move_player(player_car, m=1):
    ...
    if keys[pygame.K_BACKSPACE]:
        ...
        pygame.mixer.music.load('dzwieki\\menu.mp3')
...
if __name__ == "__main__":
    ...
    pygame.mixer.music.load(r'dzwieki\menu.mp3')
    pygame.mixer.music.set_volume(0.3)
    pygame.mixer.music.play(-1)

    v_przycisk = pygame.mixer.Sound("dzwieki\\najazd-na-przycisk.wav")
    v_auta = pygame.mixer.Sound("dzwieki\\Autka_same.mp3")
    v_czarna_dziura = pygame.mixer.Sound("dzwieki\\czarna_dziura.mp3")
    v_gra = pygame.mixer.Sound("dzwieki\\gra.mp3")
    v_menu = pygame.mixer.Sound("dzwieki\\menu.mp3")
    v_pajak = pygame.mixer.Sound("dzwieki\\pajak.mp3")
    v_poslizg = pygame.mixer.Sound("dzwieki\\poslizg.mp3")
    v_snieg = pygame.mixer.Sound("dzwieki\\snieg.mp3 ")
    v_ufo = pygame.mixer.Sound("dzwieki\\UFOLUDEK.wav")
    v_wygrana = pygame.mixer.Sound("dzwieki\\wygrana.mp3")
    v_tornado = pygame.mixer.Sound("dzwieki\\tornado.wav")

    TLO = pygame.image.load("imgs/tlo.png").convert_alpha()
    MONETA = scale_image(pygame.image.load("imgs/moneta.png"), 0.2)
    ...
    creditsy = scale_image(pygame.image.load("imgs/creditsy.png").convert_alpha(), 0.65)
    h2play = scale_image(pygame.image.load("imgs/h2play.png").convert_alpha(),0.7)
    ...
    while run:
        ...
        if tryb == "Credits":
            ...
            if przyciski[0].stan == True and (pygame.mouse.get_pressed()[0] == True or keys[pygame.K_RETURN]):
                ...
                pygame.mixer.music.stop()
                pygame.mixer.music.unload()
                pygame.mixer.music.load('dzwieki\\gra.mp3')
                pygame.mixer.music.play(loops=-1, start=0.0, fade_ms=750)
            ...
            for car in computercars:
                ...
                '''if c%150 == 0:
                    if car.point_before == car.current_point:
                        print("changepoint")
                    else:
                        car.point_before = car.current_point'''
            ...
            '''
            if c%100==0:
                pygame.mixer.Sound.play(v_auta)
            '''
            ...
            if player_car.laps>=3:
                ...
                pygame.mixer.music.stop()
                pygame.mixer.music.unload()
                pygame.mixer.music.load('dzwieki\\wygrana.mp3')
                pygame.mixer.music.play(loops=-1, start=0.0, fade_ms=750)
        elif tryb == "wenus":
