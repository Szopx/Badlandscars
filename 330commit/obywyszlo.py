...
class Ufoludek:
    def __init__(self):
        ...
        self.pozycje = [(253, 180),(77, 294),(600,100)]
        self.pos = (-1000,-1000)
...
if __name__ == "__main__":
    ...
    GREEN_CAR = scale_image(pygame.image.load("imgs/auta/en1.png"), 1.0)
    GREEN_CAR_MASK = pygame.mask.from_surface(GREEN_CAR)
    PURPLE_CAR = scale_image(pygame.image.load("imgs/auta/en2.png"), 1.1)
    PURPLE_CAR_MASK = pygame.mask.from_surface(GREEN_CAR)
    WHITE_CAR = scale_image(pygame.image.load("imgs/auta/en3.png"), 1.1)
    WHITE_CAR_MASK = pygame.mask.from_surface(GREEN_CAR)
    GREY_CAR = scale_image(pygame.image.load("imgs/auta/en4.png"), 1.1)
    ...
    PATHS = [[(778, 551), (733, 469), (604, 432), (449, 431), (266, 442),
              (170, 406), (111, 337), (142, 264), (237, 202), (358, 193),
              (421, 194), (521, 199), (941, 190), (1042, 215), (1134, 216),
              (1202, 225), (1236, 257), (1236, 310), (1199, 365), (1149, 428),
              (1123, 485), (1040, 559)],[(748,478), (697, 429), (191, 404), (101, 337), (212, 216),
              (367, 185), (466, 191),(659, 182), (782, 203),(1042, 215),
              (1134, 216), (1202, 225), (1236, 257), (1236, 310),
              (1123, 485), (1040, 559)],[(840, 551), (794, 486), (642, 479), (539, 483),
    ...
    while run:
        ...
        if tryb == "Credits":
            ...
            if przyciski[4].stan == True and (pygame.mouse.get_pressed()[0] == True )or keys[pygame.K_1]:
                ...
                computercars = [ComputerCar(2, 4, GREEN_CAR, GREEN_CAR_MASK, (900, 580), PATH1 * 3,0,0),
